package dev.lumi.eternis.block.dungeon.astract;
...
public abstract class AbstractParkourPlateBlock extends FacingBlock {
    ...
    protected AbstractParkourPlateBlock(Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)((BlockState)super.getDefaultState()).with(FACING, Direction.SOUTH));
    }
    ...
    public @Nullable BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        return (BlockState)((BlockState)this.getDefaultState().with(FACING, facing));
    }
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        ...
        if (!world.isClient && world instanceof ServerWorld serverWorld) {
            applyEffect(serverWorld, pos, state, entity);
        }
    }
    ...
    protected abstract void applyEffect(ServerWorld world, BlockPos pos, BlockState state, Entity entity);
}
